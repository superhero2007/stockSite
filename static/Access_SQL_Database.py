...
class Access_SQL_Data(object):
    def __init__(self):
        MYSQL_HOST = gethostname()
        MYSQL_LOGIN = 'root'
        MYSQL_PWD = MYSQL_HOST

        self.ENGINE = create_engine('mysql+mysqldb://'+MYSQL_LOGIN+':'+MYSQL_PWD+'@'+MYSQL_HOST+'/securities_master')
    ...
    def get_qm_eod_data (self, sec_id=None, ticker=None, start_date=None, end_date=None, data_list=['price_date','bb_ticker','securities_id','open','high','low','close','volume','adj_open','adj_high','adj_low','adj_close','adj_vol']):
        ...
        columns = select([sec_table.c.bb_ticker,
                        ...
                        tech_table.c.avg_true_range_20day,
                        tech_table.c.norm_avg_true_range_20day,
                        tech_table.c.true_range,
                        tech_table.c.avg_dir_move_idx_14day,
                        tech_table.c.avg_dir_move_idx_20day,
                        tech_table.c.avg_dir_move_idx_rating_20day,
                        tech_table.c.abs_price_osc,
                        tech_table.c.aroon_osc_20day,
                        tech_table.c.balance_of_power,
                        tech_table.c.commodity_channel_idx_20day,
                        tech_table.c.chande_mom_osc_20day,
                        tech_table.c.dir_mov_idx_20day,
                        tech_table.c.money_flow_idx_20day,
                        tech_table.c.minus_dir_ind_20day,
                        tech_table.c.minus_dir_move_20day,
                        tech_table.c.momentum_20day,
                        tech_table.c.plus_dir_ind_20day,
                        tech_table.c.plus_dir_move_20day,
                        tech_table.c.pct_price_osc,
                        tech_table.c.rate_change_20day,
                        tech_table.c.pct_rate_change_20day,
                        tech_table.c.ratio_rate_change_20day,
                        tech_table.c.roc_triple_smooth_ema_20day,
                        tech_table.c.ultimate_osc,
                        tech_table.c.williams_pctr_20day,
                        ...
                        tech_table.c.aroon_down,
                        tech_table.c.aroon_up,
                        tech_table.c.ma_converge_diverge,
                        tech_table.c.macd_signal,
                        tech_table.c.macd_hist,
